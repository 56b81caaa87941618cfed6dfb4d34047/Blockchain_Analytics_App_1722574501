            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with our cutting-edge blockchain data analysis tools. Unlock insights and opportunities hidden in the latest blockchain information.
                    </div>
                </div>
            </div>
        </footer> 
