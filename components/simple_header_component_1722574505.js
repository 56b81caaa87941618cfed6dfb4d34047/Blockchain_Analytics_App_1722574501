...
Vue.component("simple_header_component_1722574505", {
    template: `
    <header id="header-section" class="w-full">
        <nav id="nav-bar" class="bg-opacity-20 backdrop-filter backdrop-blur-lg bg-purple-100 border-b border-purple-200 py-4 dark:bg-opacity-20 dark:backdrop-filter dark:backdrop-blur-lg dark:bg-purple-900 dark:border-purple-800">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-6 mx-auto">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-pink-600 bg-purple-200 rounded-lg lg:bg-transparent lg:text-pink-500 lg:p-0 dark:text-pink-300 lg:dark:text-pink-400" aria-current="page">Real-time Blockchain Analysis</a></li>
                        <li id="nav-item-1"><a href="#" class="block py-2 pl-3 pr-4 text-purple-700 rounded-lg hover:bg-purple-200 lg:hover:bg-transparent lg:hover:text-pink-500 lg:p-0 dark:text-purple-300 lg:dark:hover:text-pink-400 dark:hover:bg-purple-800 dark:hover:text-pink-300 lg:dark:hover:bg-transparent">Smart Contract Auditing</a></li>
